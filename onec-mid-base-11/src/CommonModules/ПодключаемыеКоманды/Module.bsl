...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	// Начало доработки Савельева 17.08.2026 Добавление Контактного лица на форму
	РаботаСФормамиДобавлениеКЛ_ДЗ.РаботаСФормамиДобавитьКонтактноеЛицо(Форма);
	// Конец доработки 17.08.2026
КонецПроцедуры
